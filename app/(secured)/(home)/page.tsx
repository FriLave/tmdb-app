...
export default function Home() {
    const { data: movies, isLoading: isMoviesLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await httpClient<ApiPaginatedResponse<Movie>>("/api/movies/discover/toprated");
            return res.data;
        },
    })
    ...
    const { data: tv, isLoading: isTvLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await httpClient<ApiPaginatedResponse<Serie>>("/api/tv/discover/toprated");
            return res.data;
        },
    })
